...
This repository contains the **frontend of OhMyUniversity!**, implemented in Angular.
It manages all **UI components, pages, client-side logic, and integration with the backend API**.
